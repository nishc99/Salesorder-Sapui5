		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "salesorder",
									"targetURL": "#comexamplesalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplesalesorder-display": {
								"semanticObject": "comexamplesalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.salesorder",
									"url": sap.ui.require.toUrl("com/example/salesorder")
								}
							}
						}
					}
